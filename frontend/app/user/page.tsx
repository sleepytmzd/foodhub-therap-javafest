          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-shrink-0">
              <div className="flex gap-2">
                <Link
                  href="/explore"
                  className="inline-flex items-center justify-center rounded-md px-4 py-2 bg-primary text-primary-foreground hover:scale-105 transition-transform"
                >
                  Explore
                </Link>
                <Link
                  href="/user/edit"
                  className="inline-flex items-center justify-center rounded-md px-4 py-2 border bg-transparent text-sm hover:scale-105 transition-transform"
                >
                  Edit
                </Link>
              </div>
